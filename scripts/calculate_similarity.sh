...
psql -U andio -h localhost -f scripts/clustering_process_2cosine.sql sfpark


echo
echo "-------------------------------------------------"
echo "Calculating Earth Mover's Distance between clusters..."
psql -U andio -h localhost -f scripts/clustering_process_2a_emd.sql sfpark
...
psql -U andio -h localhost -f scripts/clustering_process_3tojson.sql sfpark
