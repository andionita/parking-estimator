...
\begin{table}[!ht]
    ...
    \begin{tabular}{ | c | c | c | c | c | c |}
    \hline
    \textbf{Data type}& \textbf{Current Availability} & \textbf{Source} \\ \hline
    \textbf{Sensors} & available & sonah UG \\ \hline
    \textbf{Parking Meters} & partially available & Aachen City via sonah UG \\ \hline
	\textbf{Car Parks} & partially available & Aachener Parkhaus GmbH \\ \hline
	\textbf{OSM} & available & open and free \\ \hline
    \textbf{User-generated} & not yet available & sonah UG \\ \hline
	\textbf{Events} & not yet available & unknown for now\\ \hline
	\textbf{Weather} & partially available & Deutscher Wetterdienst via sonah UG \\ \hline
	\textbf{Traffic flows} & not yet available & unknown for now\\ \hline
    \end{tabular}}
