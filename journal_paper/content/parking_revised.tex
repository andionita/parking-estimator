...
%\comby{(xxxxxxxxxx)}
\begin{center}
	\linespread{0.4} \tiny  \noindent Preprint of an article to be published in Int J. on Artificial Intelligence Tools (IJAIT)  \copyright 2019 [copyright World Scientific Publishing Company] \url{https://www.worldscientific.com/worldscinet/ijait}.
%	\linespread{2}\Large\bfseries The Great Thesis About Some Very Great Things Indeed With a Pretty Long Title That Will Probably Be Split Between at Least Two Lines	Or So
\end{center}
\end{history}
