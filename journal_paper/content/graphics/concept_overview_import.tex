...
% center second row
\node[graph text, below of=M3, yshift=-6em, xshift=2.9em] (E2) {$\mathcal{M}_i(X)$};
%\draw[dashed,->] (M3) -- (E2);
\node[graph text, right of=E2, xshift=0.5em] (E3) {$\ast\:    
 sim_{ij}$};
\node[graph text, left of=E2, xshift=-1em] (E1) {$pred_{ij}=$};
