...
% Models
\node[graph cyantext, below of=C1, xshift=-2em] (M1) {$\mathcal{M}_1$};
%\node[graph text, below of=C2, xshift=-2em] (M2) {$...$};
\node[graph cyantext, below of=C3, xshift=-2em] (M3) {$\mathcal{M}_i$};
%\node[graph text, below of=C4, xshift=-2em] (M4) {$...$};
\node[graph cyantext, below of=C5, xshift=-2em] (M5) {$\mathcal{M}_n$};
