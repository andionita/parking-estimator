...
% center first row
\node[graph cyantext, below of=C3, yshift=-6.8em] (D2) {$\mathcal{C}_i$};
\draw[dashed,->,color=cyan] (C3) -- (D2);
\node[graph cyantext, left of=D2, xshift=0em] (D1) {$sim_{ij}=$};
\node[graph cyantext, right of=D2, xshift=-1em] (D3) {$\sim\,\mathcal{C}'_j$};
\draw[dashed,->,color=cyan] (C'3) -- (D3);
