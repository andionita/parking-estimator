\section{Introduction}
	...
	\begin{romanlist}
		...
		Data such as opening hours would be interesting to include in the mathematical representations, which would then take into account the number of public amenities that are available at a certain point in time.
